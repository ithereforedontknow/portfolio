    ...
    <div class="d-flex justify-content-center align-items-center" id="home" style="height: 100svh;">
        <div class="container d-flex justify-content-center">
            <div class="row align-items-center">
                ...
                <div class="col">
                    <img class="rounded-circle justify-content-end img" src="{{asset('./image.jpeg')}}" style="width: 500px; border: white 5px solid">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="container-sm d-flex justify-content-center">
                <div class="row align-items-center">
                    ...
                    <div class="col">
                        ...
                        <div class="text-center">
                            <img class="rounded-circle justify-content-end" src="{{asset('./cat.jpg')}}" style="width: 300px; border: white 5px solid">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="d-flex justify-content-center align-items-center" id="contact" style="height: 100svh;">
        <div class="container-sm d-flex justify-content-center align-items-center">
            <div class="row align-items-center">
                <div class="col">
                    <div class="text-center">
                        <img class=" justify-content-end" src="{{asset('./user.svg')}}" style="width: 300px; ">
                    </div>
                </div>
                <div class="col">
                    <div>
